/* Diccionario EN de la ficha de producto (Emulsión humectante corporal 250 ml).
   Reescritura de marca (brand/03-identidad-verbal.md), no traducción literal.
   Frase de seguridad usa la redacción oficial de brand/03 §"La frase de seguridad". */
window.VO_I18N_PAGE = {
  "p-kicker": "Everyday Care · Daily line",
  "p-nombre": "Body moisturizing emulsion",
  "p-piel": "Normal to dry skin",
  "p-uso": "Daily use",
  "p-lead": "Light, fast-absorbing. The everyday alternative to body oil: the same oil from our own grove, emulsified to sink in within seconds and never mark your clothes.",
  "p-stock": "In stock · Made in Maipú, Mendoza",

  "gal-envase": "See the bottle",
  "gal-textura": "See the texture",
  "gal-olivar": "See the grove",
  "gal-aplicacion": "See it applied",
  ...
  "ship-2": "Formulated by Julia with polyphenols from the 1890 grove.",
  "ship-3": "No synthetic fragrance. Lasts 6 to 8 weeks with daily use.",

  "edu-kicker": "Understand it before you buy it",
  "edu-h2": "What it does, who it's for, how to use it",
  ...
  "warn-p": "<b style=\"color:var(--corteza)\">The first week</b>, the tight, dry feeling eases. <b style=\"color:var(--corteza)\">By the first month</b>, skin feels more even to the touch, especially if you exfoliate once a week. <b style=\"color:var(--corteza)\">By three months</b>, it holds up better against cold and high-altitude sun.<br><br>What it does <b style=\"color:var(--corteza)\">not</b> do: it doesn't erase scars, doesn't treat any skin condition, doesn't replace sunscreen, and doesn't reduce body fat. It's cosmetics, not medicine — see Safety below.",

  "combina-kicker": "What it pairs with",
  "combina-h2": "The emulsion works on its own. Paired, it works even better.",
  "combina-lead": "These three products are used before or after the emulsion, in this order.",

  "card1-label": "Before",
  "card1-title": "Coarse exfoliating cream",
  "card1-why": "Once a week, in the shower: freshly exfoliated skin absorbs far more.",

  "card2-label": "Before",
  "card2-title": "Bath foam",
  "card2-why": "A soak, then the emulsion while skin is still warm: the simplest ritual, and the one that shows the most.",

  "card3-label": "The origin",
  "card3-title": "Vallesi Arauco",
  "card3-why": "The same oil, by its original path: the table. Not used on skin — it's the other half of the story.",
  ...
  "ritual-lead1": "In this ritual, the emulsion is the body step: applied after the shower, while skin is still damp, while the hyaluronic acid emulsion and facial moisturizing cream do their part on the face. Everything absorbs better on damp skin — it costs nothing and changes the result.",
  "ritual-lead2": "It's also the closing step of the \"Exfoliate once a week\" and \"A real bath\" rituals: it can be bought on its own, but it goes further as part of any of the three.",
