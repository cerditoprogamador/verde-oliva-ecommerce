/* Diccionario EN de la ficha de producto (Crema exfoliante fina 50 gr).
   Reescritura de marca (brand/03-identidad-verbal.md), no traducción literal. */
window.VO_I18N_PAGE = {
  "p-kicker": "Everyday Care · Daily line",
  "p-nombre": "Fine exfoliating cream",
  "p-piel": "All skin, used in moderation",
  "p-uso": "1-2 times a week, at night",
  "p-lead": "A fine-grain exfoliant, for the face: gently renews, leaves skin smoother and helps whatever you apply next absorb better.",
  ...
  "ship-3": "No synthetic fragrance. 50 g jar.",
  ...
  "combina-lead": "The clay mask goes after, and the facial cream closes the ritual.",

  "card1-label": "After",
  "card1-title": "Clay mask",
  "card1-why": "Freshly exfoliated skin gets more out of the clay's deep clean.",

  "card2-label": "To close",
  "card2-title": "Facial moisturizing cream",
  "card2-why": "Seals in hydration after renewing the surface.",
